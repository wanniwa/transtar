...
class I18nTransHandler(BaseTransHandler):
    ...
    def handle(self, file_path):
        ...
        if parent_folder_name.lower() == "i18n":
            translate_file_path = os.path.join(file_folder_path, f"{uiConfig.to_language.value}.json")
        else:
            ...
            if grandparent_folder_name.lower() == "i18n":
                ...
                target_lang_folder = os.path.join(grandparent_folder_path, uiConfig.to_language.value)
