    ...
    def handle(self, file_path):
        ...
        for jsonObject in shops:
            ...
            if quote:
                ...
                localized_quote[appConfig.to_language.value] = self.get_new_value(quote_key, quote,
                                                                                  TargetAssetType.PlainText)
            ...
            if closed_message:
                ...
                localized_closed_message[appConfig.to_language.value] = self.get_new_value(closed_message_key,
                                                                                           closed_message,
                                                                                           TargetAssetType.PlainText)
...
class JATransHandler(BaseTransHandler):
    ...
    def do_ja_localization(self, localization, key, value, relative_path):
        ...
        if self.context.trans_flag:
            localization[appConfig.to_language.value] = self.get_new_value(trans_key, value, TargetAssetType.PlainText)
